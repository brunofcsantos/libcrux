...
use libcrux_p256::ecdsa_sign_p256_sha2;
...
fn bench_ecdsa_sign_cycles(c: &mut Criterion<CpuCycles>) {
    ...
    let mut group = c.benchmark_group("ecdsa_sign_p256_sha2");
    group.throughput(Throughput::Bytes(msg_len as u64));
    group.measurement_time(Duration::from_secs(10));

    group.bench_function("ecdsa_sign_p256_sha2", |b| {
        b.iter(|| {
            let _ = ecdsa_sign_p256_sha2(
